...
pub enum Error {
	...
	ParseFailed { path:PathBuf, cause:toml::de::Error },
}
...
impl Metadata {
	...
	#[cfg(target_os = "macos")]
	pub fn apple(&self) -> &crate::apple::config::Metadata { &self.apple }

	pub fn android(&self) -> &crate::android::config::Metadata { &self.android }
}
